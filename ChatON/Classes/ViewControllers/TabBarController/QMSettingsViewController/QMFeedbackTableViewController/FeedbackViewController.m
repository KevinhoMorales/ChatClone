...
- (void)viewDidLoad {
    [super viewDidLoad];
     ...
     self.navigationController.navigationBar.barTintColor = [UIColor colorWithRed:0 green:33.0/255.0 blue:87.0/255.0 alpha:1.0];
...
- (IBAction)writeAnEmailTapped:(id)sender {
    ...
    [REMailComposeViewController present:^(REMailComposeViewController *mailVC) {
        ...
        NSString *recipient = @"HeyYapp@heyyapp.com";
