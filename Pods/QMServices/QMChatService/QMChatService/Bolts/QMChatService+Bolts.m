...
- (BFTask *)sendAttachmentMessage:(QBChatMessage *)attachmentMessage toDialog:(QBChatDialog *)dialog withAttachmentVideo:(NSData *)videodata {
    
    BFTaskCompletionSource* source = [BFTaskCompletionSource taskCompletionSource];
    
    [self sendAttachmentMessage:attachmentMessage toDialog:dialog withAttachmentVideo:videodata completion:^(NSError *error) {
...
- (BFTask *)sendAttachmentMessage:(QBChatMessage *)attachmentMessage toDialog:(QBChatDialog *)dialog withAttachmentAudio:(NSData *)audiodata {
    
    BFTaskCompletionSource* source = [BFTaskCompletionSource taskCompletionSource];
    
    [self sendAttachmentMessage:attachmentMessage toDialog:dialog withAttachmentAudio:audiodata completion:^(NSError *error) {
